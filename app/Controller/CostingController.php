...
class CostingController extends AppController {
  ...
  function export($id){
    ...
    $row[5] = '';
    $inkLostCostPc = round($costingDb['Costing']['printing_color']*$settings['ink_loss_prn_color']/1000 * 100000 / $costingDb['Costing']['quantity']*$costingDb['Costing']['printing_cost']);
    $row[6] = $inkLostCostPc;
    $row[7] = 'Vnd/pc';
    $row[8] = $inkLostCostPc;
    $data[] = $row;
    ...
    $row[4] = 'Trial Cost/pc:';
    $row[5] = '';
    $trialCostPc = round($costingDb['Costing']['paper_cutting']* $costPC * $settings['trial_prn'] * $costingDb['Costing']['printing_color']/ $costingDb['Costing']['quantity']*$costingDb['Costing']['printing_cost']);
    $row[6] = $trialCostPc;
    $row[7] = 'Vnd/pc';
    $row[8] = $trialCostPc;
    $data[] = $row;
    ...
    $row[4] = 'Film Cost/pc :';
    $row[5] = '';
    $filmCostPc = round($printingAreaPC * $settings['film_cost'] * $costingDb['Costing']['printing_films'] * $costingDb['Costing']['paper_cutting'] * $costingDb['Costing']['printing_color'] / $costingDb['Costing']['quantity']);
    $row[6] = $filmCostPc;
    $row[7] = 'Vnd/pc';
    $row[8] = $filmCostPc;
    $data[] = $row;
    ...
    $row[5] = 'M2';
    $row[6] = round($bFluteArea * $costingDb['Costing']['b_flute_substance']/1000*$costingDb['Costing']['quantity']);
    ...
    $row[4] = 'Mould Cost /pc :';
    $row[5] = '';
    $dieCut1 = round($costingDb['Costing']['paper_length'] * $costingDb['Costing']['paper_width'] / 10000 * $settings['die_cut']/$costingDb['Costing']['paper_cutting']/$costingDb['Costing']['quantity'] * $costingDb['Costing']['die_cut'] * $costingDb['Costing']['paper_cutting']);
    $row[6] = $dieCut1;
    $row[7] = 'Vnd/pc';
    $row[8] = $dieCut1;
    $data[] = $row;
    ...
    $grossMU = round(($prnCostPc + $timeWasteCostPc + $manufacturingCost + $dieCut2)/$sellingPrice*100+$costingDb['Costing']['mk'], 1);
    //row 57
    $row = array();
    $row[0] = '';
    $row[1] = '';
