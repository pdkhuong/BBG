...
class ProductOrderController extends AppController {
  ...
  public function index() {
    ...
    $page = isset($this->request->params['paging']['ProductOrder']['page']) ? intval($this->request->params['paging']['ProductOrder']['page']) : 1;
  ...
  public function report($id){
    ...
    if($dataObj){
      ...
      $text1 = "Người duyệt ".$tabSpace." Người lập phiếu";
      $pdf->MultiCell(205, 5,$text1, 0, 'J', 0, 1, '', '', true, null, true);
      $text2 = "<b>".$dataObj['CreatedUser']['display_name']."&emsp;&emsp;&emsp;<b>".$tabSpace.$dataObj['ApprovedUser']['display_name'];
      $pdf->setX(31);
