...
class File extends AppModel {
  ...
  public function beforeDelete($cascade = TRUE) {
    ...
    $file_model->deleteAll(array('FileModel.file_id' => $this->id), FALSE, TRUE);
    $file_model_multi_lang->deleteAll(array('MultilanguageFileModel.file_id' => $this->id));
    $file_category_file->deleteAll(array('FileCategoryFile.file_id' => $this->id));
  ...
  public function saveUploadFile($parameters) {
  ...
  public function getFileModels($model, $model_id, $category_code=NULL) {
    ...
    $file_models = $this->FileModel->find('all', array(
      ...
      'conditions' => $conditions,
      'order' => array('FileModel.order' => 'ASC'),
      'fields' => array('FileModel.*', 'File.*', 'MultilanguageFileModel.*', 'FileForMultilanguage.*'),
    ));
