var FilePlugin = {
  ...
  openSelectFile: function() {
    ...
    bodyElement.on("click", ".form-file-element-button-choose-files", function(e) {
      FilePlugin.globalVariable.page = null;
  ...
  clearElement: function(eId, categoryCode) {
    var fileIdElement = '<input type="hidden" name="data[File][selected_files][' + categoryCode + '][][id]" value="">';
  ...
  chooseFileFromList: function() {
    ...
    bodyElement.on("click", ".file-form-element-choose-file-one-lang", function() {
      ...
      var mainFileId = $(this).attr('data-for_file_id');
      FilePlugin.globalVariable.mainFileId = mainFileId;
  ...
  removeFileSelected: function() {
    $("button.sf-file-btn-remove").on("click", function(e) {
      ...
      FilePlugin.clearElement(eId, categoryCode);
      return false;
    });
    var bodyElement = $("body");
