<div id="left">
  ...
  <?php
  $listPermission = $controller->listPermission();
  $rolesP = array();
  $rolesC = array();
  if($listPermission){
  ...
  ?>
    <ul id="menu" class="collapse affix-top">
      ...
      <?php if($isSuperAdmin || isset($rolesC['DashboardController'])):?>
      <li class="<?php if($this->params['controller'] == 'Dashboard') echo 'active'?>">
          <a href="/"><i class="fa fa-home"></i> Dashboard</a>
      </li>
      <?php endif;?>
      <?php if($isSuperAdmin || isset($rolesC['CalendarController'])):?>
      ...
      <?php endif;?>
      <?php if($isSuperAdmin || isset($rolesC['CustomerController'])):?>
      ...
      <?php endif;?>
      <?php if($isSuperAdmin || isset($rolesC['LeadController'])):?>
      ...
      <?php endif;?>
      <?php if($isSuperAdmin || isset($rolesC['VendorController'])):?>
      ...
      <?php endif;?>
      <?php if($isSuperAdmin || isset($rolesC['ProductController'])):?>
      ...
      <?php endif;?>
      <?php if($isSuperAdmin || isset($rolesC['CostingController'])):?>
      ...
      <?php endif;?>
      <?php if($isSuperAdmin || isset($rolesC['FileController'])):?>
      ...
      <?php endif;?>
      <?php if($isSuperAdmin || isset($rolesP['User'])):?>
      ...
      <?php endif;?>
      <?php if($isSuperAdmin || isset($rolesC['SettingsController'])):?>
