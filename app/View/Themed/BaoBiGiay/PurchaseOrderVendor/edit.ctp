...
<div class="well form-horizontal page-body posts form">
  ...
  ?>
    ...
    <div class="form-group required <?php if($isErrorOrderDate) echo 'has-error error' ?>">
      ...
      <div class="col col-md-3">
        <div class='input-group date _datetime_picker' data-date-format="YYYY-MM-DD">
          <input value="<?php echo isset($this->data['PurchaseOrderVendor']['order_date']) && $this->data['PurchaseOrderVendor']['order_date'] ? reformatDate($this->data['PurchaseOrderVendor']['order_date']) : '' ?>" name="data[PurchaseOrderVendor][order_date]" type='text' class="form-control" readonly="readonly"/>
    ...
    <div class="form-group required <?php if($isErrorReceivedDate) echo 'has-error error' ?>">
      ...
      <div class="col col-md-3">
        <div class='input-group date _datetime_picker' data-date-format="YYYY-MM-DD">
          <input value="<?php echo isset($this->data['PurchaseOrderVendor']['received_date']) && $this->data['PurchaseOrderVendor']['received_date'] ? reformatDate($this->data['PurchaseOrderVendor']['received_date']) : '' ?>" name="data[PurchaseOrderVendor][received_date]" type='text' class="form-control" readonly="readonly"/>
          <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
        </div>
      </div>
      <div class="col col-md-6">
