...
<div class="well form-horizontal page-body posts form _purchase_order">
  ...
  ?>
    ...
    <div class="form-group required <?php if($isErrorOrderDate) echo 'has-error error' ?>">
      ...
      <div class="col col-md-3">
        <div class='input-group date _datetime_picker' data-date-format="YYYY-MM-DD">
          <input value="<?php echo isset($this->data['PurchaseRequest']['order_date']) && $this->data['PurchaseRequest']['order_date'] ? reformatDate($this->data['PurchaseRequest']['order_date']) : '' ?>" name="data[PurchaseRequest][order_date]" type='text' class="form-control" readonly="readonly"/>
    ...
    <div class="form-group required <?php if($isErrorReceivedDate) echo 'has-error error' ?>">
      ...
      <div class="col col-md-3">
        <div class='input-group date _datetime_picker' data-date-format="YYYY-MM-DD">
          <input value="<?php echo isset($this->data['PurchaseRequest']['received_date']) && $this->data['PurchaseRequest']['received_date'] ? reformatDate($this->data['PurchaseRequest']['received_date']) : '' ?>" name="data[PurchaseRequest][received_date]" type='text' class="form-control" readonly="readonly"/>
          <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
        </div>
      </div>
      <div class="col col-md-6">
