        ...
        <?php foreach($addedContact as $contactId => $contact):?>
          <tr id="_row_<?php echo $contactId?>">
            <td>
              ...
              <?php echo $this->Form->input("VendorContact.{$contactId}.name", array('type' => 'hidden', 'value' => $contact['name']));?>
            </td>
            <td>
              <?php echo $contact['email']?>
              <?php echo $this->Form->input("VendorContact.{$contactId}.email", array('type' => 'hidden', 'value' => $contact['email']));?>
            </td>
            <td>
              <?php echo $contact['phone']?>
              <?php echo $this->Form->input("VendorContact.{$contactId}.phone", array('type' => 'hidden', 'value' => $contact['phone']));?>
            </td>
            <td>
              <?php echo $contact['address']?>
              <?php echo $this->Form->input("VendorContact.{$contactId}.address", array('type' => 'hidden', 'value' => $contact['address']));?>
              <?php echo $this->Form->input("VendorContact.{$contactId}.info", array('type' => 'hidden', 'value' => $contact['info']));?>
              <?php echo $this->Form->input("VendorContact.{$contactId}.fax", array('type' => 'hidden', 'value' => $contact['fax']));?>
            </td>
            <td>
...
<script id="tableRowTemplateContact" type="text/x-jQuery-tmpl">
  <tr id="_row_${id}">
    <td>${name}</span>
      <?php echo $this->Form->input('VendorContact.${id}.name', array('type' => 'hidden', 'value' => '${name}'));?>
    </td>
    <td>
      ${email}
      <?php echo $this->Form->input('VendorContact.${id}.email', array('type' => 'hidden', 'value' => '${email}'));?>
    </td>
    <td>
      ${phone}
      <?php echo $this->Form->input('VendorContact.${id}.phone', array('type' => 'hidden', 'value' => '${phone}'));?>
    </td>
    <td>
      ${address}
      <?php echo $this->Form->input('VendorContact.${id}.address', array('type' => 'hidden', 'value' => '${address}'));?>
      <?php echo $this->Form->input('VendorContact.${id}.info', array('type' => 'hidden', 'value' => '${info}'));?>
      <?php echo $this->Form->input('VendorContact.${id}.fax', array('type' => 'hidden', 'value' => '${fax}'));?>
    </td>
    <td>
