          ...
          <tbody>
            ...
            foreach ($dataList as $data):
              ...
              <tr>
                ...
                <td>
                  <?= $this->Html->link('<i class="fa fa-file-text"></i>', Router::url(array('action' => 'view', $data['Vendor']['id'])), array('class' => 'btn btn-default btn-sm', 'escape' => false, 'title' => __('View Detail'))) ?>
                  <?= $this->Html->link('<i class="fa fa-edit"></i>', Router::url(array('action' => 'edit', $data['Vendor']['id'])), array('class' => 'btn btn-default btn-edit btn-sm', 'escape' => false, 'title' => __('Edit'))) ?>
                  <?= $this->Form->postLink('<i class="fa fa-trash-o"></i>', Router::url(array('action' => 'delete')) . '/' . $data['Vendor']['id'], array('class' => 'btn btn-default btn-delete btn-sm', 'escape' => false, 'title' => __('Delete')), __('Are you sure you want to delete #%s?', $data['Vendor']['id'])) ?>
                </td>
              </tr>
              <?php
            endforeach;
