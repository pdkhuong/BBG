<table cellpadding='20' cellspacing='3' width="100%">
  <tr>
    ...
    <td> Số <b><?php echo $data['WorksSheet']['order_no']?></b></td>
  </tr>
  <tr>
  ...
  <tr>
    <td>Số lượng: <b><?php echo number_format($data['WorksSheet']['num_product'], 0, '.', '.')?>
        (giá <?php echo number_format($data['OutputProduct']['price'], 0, ',', '.')?>vnđ)</b>
    </td>
    <td>ĐVT: <b><?php echo $listUnit[$data['OutputProduct']['product_unit_id']]['name']?></b></td>
  </tr>
  <tr>
    <td>Ngày giao: <b><?php echo reformatDate($data['WorksSheet']['delivery_date'], 'd/m/Y')?></b></td>
  ...
  <tr>
    <td>Ra: <?php echo $cutting ." Con/tờ in"?></td>
    <td></td>
  </tr>
  <tr>
    <td>Số lượng: <?php echo number_format($reportNum, 0, ',', '.')?> Tấm (tờ in) </td>
    <td></td>
  </tr>
  <tr>
    <td>Hao phí: <?php echo number_format($haoPhi, 0, ',', '.')?> tờ</td>
    <td></td>
  </tr>
  <tr>
...
<table cellpadding='0' cellspacing='0' width="90%" border="1px">
  ...
  <tr>
    ...
    <td width="20%"> <?php echo $progress['WorksSheetProgress']['location']?></td>
