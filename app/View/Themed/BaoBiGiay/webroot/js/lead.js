	...
	function clickEdit(){
		$('._editContact').click(function(){
			...
			if(td.length) {
				...
				$('#_contact_name').val($('#LeadContact' + contactId + 'Name').val());
				$('#_contact_email').val($('#LeadContact' + contactId + 'Email').val());
				$('#_contact_phone').val($('#LeadContact' + contactId + 'Phone').val());
				$('#_contact_address').val($('#LeadContact' + contactId + 'Address').val());
				$('#_contact_info').val($('#LeadContact' + contactId + 'Info').val());
				$('#_contact_fax').val($('#LeadContact' + contactId + 'Fax').val());
			}
			$('#contactModal').modal();
		});
	}
